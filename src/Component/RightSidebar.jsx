  ...
  return (
    <>
      ...
      <div className="w-full h-full bg-[rgb(249,245,245)]">
        ...
        <div className="relative h-[30vh]">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center ">
            <h1 className="text-orange-700  font-bold text-xl uppercase">
              How to Cook it
            </h1>
            <p
            ...
            >
              ...
              <u>{publisher}</u>. Please check out directions at their website.
            </p>
            <button
              className={`mt-5 border bg-orange-700 text-white font-bold px-10 cursor-pointer rounded-full py-3`}
            >
              <a href={source_url} target="__blank">
                Direction
              </a>
            </button>
          </div>
      ...
      <div
        ...
        } z-20 min-h-[10vh] h-auto absolute top-15 right-0`}
      >
